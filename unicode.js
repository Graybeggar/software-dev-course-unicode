...
let firstCodePoint; // let firstCodePoint = inputString.charCodeAt(0);  // Unicode code point of 'C'
let thirdCodePoint; // let thirdCodePoint = inputString.charCodeAt(2);  // Unicode code point of 'd'
...
let swappedString; // let swappedString = String.fromCharCode(lastCharCode) + inputString.slice(1, inputString.length - 1) + String.fromCharCode(firstCharCode);
